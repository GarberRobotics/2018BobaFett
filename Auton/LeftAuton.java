...
public class LeftAuton extends Command{
	...
	public void LeftScale(){
		...
		}else if(Robot.frontRight.getSelectedSensorPosition(0) < slightlyForward + 2300 && stepFourLeft){
			stepThreeLeft = false;
			autonFunctions.ElevatorUp();
			l = r = .42;
		...
		}else if(Robot.frontRight.getSelectedSensorPosition(0) >= slightlyBackward - 6500 && stepSixLeft){
			l = r = -.42;
